...
type CreateReactAgentParams = {
  /** LLM to use for the agent. */llm: BaseLanguageModelInterface; /** Tools this agent has access to. */
  tools: ToolInterface[];
  /**
...
declare function createReactAgent({
  ...
  steps: AgentStep[];
}, _$_langchain_core_agents0.AgentAction | _$_langchain_core_agents0.AgentFinish>>;
//#endregion
