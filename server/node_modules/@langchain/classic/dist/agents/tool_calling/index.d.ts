...
import * as _$_langchain_core_agents0 from "@langchain/core/agents";
...
type CreateToolCallingAgentParams = {
   ...
   */
  llm: LanguageModelLike; /** Tools this agent has access to. */
  tools: StructuredToolInterface[] | ToolDefinition[]; /** The prompt to use, must have an input key of `agent_scratchpad`. */
...
}, _$_langchain_core_agents0.AgentFinish | _$_langchain_core_agents0.AgentAction[]>;
//#endregion
