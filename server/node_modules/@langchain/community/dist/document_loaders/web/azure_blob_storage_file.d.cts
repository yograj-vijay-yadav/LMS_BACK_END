...
import * as _$_langchain_core_documents0 from "@langchain/core/documents";
...
declare class AzureBlobStorageFileLoader extends BaseDocumentLoader {
   ...
   */
  load(): Promise<_$_langchain_core_documents0.Document<Record<string, any>>[]>;
}
//#endregion
export { AzureBlobStorageFileLoader };
//# sourceMappingURL=azure_blob_storage_file.d.cts.map