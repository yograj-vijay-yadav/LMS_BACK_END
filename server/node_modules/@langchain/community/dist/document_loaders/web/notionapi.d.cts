...
declare const isPageResponse: (res: GetResponse) => res is GetPageResponse;
declare const isDatabaseResponse: (res: GetResponse) => res is GetDatabaseResponse;
declare const isErrorResponse: (res: GetResponse) => res is APIResponseError;
declare const isPage: (res: GetResponse) => res is PageObjectResponse;
declare const isDatabase: (res: GetResponse) => res is DatabaseObjectResponse;
