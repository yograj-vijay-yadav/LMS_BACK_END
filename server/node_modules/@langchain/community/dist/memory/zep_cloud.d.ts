...
import { Memory } from "@getzep/zep-cloud/api/index.js";

//#region src/memory/zep_cloud.d.ts
declare const zepMemoryContextToSystemPrompt: (memory: Memory) => string;
declare const condenseZepMemoryIntoHumanMessage: (memory: Memory) => HumanMessage<_$_langchain_core_messages0.MessageStructure<_$_langchain_core_messages0.MessageToolSet>>;
declare const zepMemoryToMessages: (memory: Memory) => BaseMessage<_$_langchain_core_messages0.MessageStructure<_$_langchain_core_messages0.MessageToolSet>, _$_langchain_core_messages0.MessageType>[];
/**
