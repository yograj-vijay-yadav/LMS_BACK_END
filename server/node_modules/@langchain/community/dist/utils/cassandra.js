...
var cassandra_exports = /* @__PURE__ */ __exportAll({
...
var CassandraClientFactory = class CassandraClientFactory {
	...
	*/
	static async getClient(args) {
		return new Client(await this.processArgs(args));
	}
	/**
	...
	*/
	static async getAstraDefaultBundleLocation(astraArgs) {
		...
		scbFileName += ".zip";
		return path.join(dir, scbFileName);
	}
	/**
	...
	*/
	static async downloadAstraSecureConnectBundle(astraArgs, scbPath) {
		...
		const fileHandle = await fs.open(scbPath, "wx", 384);
		try {
...
//#endregion
export { CassandraClientFactory, CassandraTable, cassandra_exports };
