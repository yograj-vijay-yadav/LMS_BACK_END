...
declare function todoListMiddleware(options?: TodoListMiddlewareOptions): AgentMiddleware<z.ZodObject<{
...
}>, undefined, unknown, readonly [_$_langchain_core_tools0.DynamicStructuredTool<z.ZodObject<{
  ...
  messages: ToolMessage<_$_langchain_core_messages0.MessageStructure<_$_langchain_core_messages0.MessageToolSet>>[];
}, string>, unknown, "write_todos">]>;
//#endregion
export { TODO_LIST_MIDDLEWARE_SYSTEM_PROMPT, Todo, TodoListMiddlewareOptions, todoListMiddleware };
//# sourceMappingURL=todoListMiddleware.d.ts.map